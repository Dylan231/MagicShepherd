...
public class Sheep : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Vector3 Sheep = new Vector3(rb.transform.position.x, 0, rb.transform.position.z);
     ...
     //   Vecotr3 dirx = newposx - sheepx;
      //  Vector3 dirz = newposy - sheepy;
        ...
        // apply movement
        transform.Translate(new Vector3((newx * speed * Time.deltaTime), 0, (newy * speed * Time.deltaTime)));
